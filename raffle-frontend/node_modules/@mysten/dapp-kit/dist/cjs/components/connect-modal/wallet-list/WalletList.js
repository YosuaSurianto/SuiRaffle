...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: container2, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "button",
    {
...
function WalletList({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { className: container, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
    ...
    WalletListItem,
    {
      name: import_slush_wallet.SLUSH_WALLET_NAME,
      icon: import_slush_wallet.SLUSH_WALLET_ICON,
